...
import com.santosh.moviesapp.services.impl.MovieServiceImpl;
...
public class MovieDaoImpl implements MovieDao {
   ...
   /**
	 ...
	 */
	public MovieDaoImpl(MovieRespository movieRespository) {
		super();
		...
		public List<Movie> retrieveMovies() {
			List<Movie> movies = (List<Movie>) movieRespository.findAll();
		...
		@Override
		public List<Movie> searchMovies(List<InterestDTO> interests ) {
			List<Movie> cases = movieRespository.findAll(MovieSearchSpecificaton.findByCriteria(interests));
			return cases;
		}
